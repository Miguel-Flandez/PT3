                ...
                <div class="container-fluid">
                    ...
                    <?php
                        ...
                        if (isset($_GET['search'])) {
                            ...
                            if (!empty($search)) {
                                $query = mysqli_query($conn, "SELECT * FROM user_tbl WHERE (firstname LIKE '%" . $search . "%') OR (lastname LIKE '%" . $search . "%')");
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <!-- Uncomment this line if you have a JavaScript function to handle deletion -->
